...
buttonclick2.addEventListener('click', function myFunction(){
   ...
   console.log(typeof x)
    ...
    if (x < 1 || x > 20) {
      ...
      text = "Your current total is: $" + (x*12.99);
    
    document.getElementById("inputmessage2").innerHTML = text;
...
document.getElementById("closeForm2").submit();
  ...
  buttonclick3.addEventListener('click', function myFunction(){
     ...
     console.log(typeof x)
      ...
      document.getElementById("inputmessage3").innerHTML = text;
  ...
  buttonclick4.addEventListener('click', function myFunction(){
      ...
      document.getElementById("inputmessage4").innerHTML = text;
  ...
  buttonclick5.addEventListener('click', function myFunction(){
     ...
     console.log(typeof x)
      ...
      document.getElementById("inputmessage5").innerHTML = text;
  ...
  buttonclick6.addEventListener('click', function myFunction(){
     ...
     console.log(typeof x)
      ...
      document.getElementById("inputmessage6").innerHTML = text;
  ...
  document.getElementById("closeForm6").submit();
    ...
    nursery*
document.getElementById('jar').addEventListener('click', function myFunction(){
    // Get the value of the input field with id="numb"
    let amount = document.getElementById("number1").value;
    // If x is Not a Number or less than one or greater than 10
    let text1;
    if (amount < 1 || amount > 20) {
      text1 = "Please enter a number between 1 and 20";
      document.getElementById("inputmessage").innerHTML = text1;

    } else {
      text1 = "Your current total is: $" + (amount*12.99);
    document.getElementById("inputmessage").innerHTML = text1;}
